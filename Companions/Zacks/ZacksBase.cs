    ...
    public class ZacksBase : TerraGuardianBase
    {
        ...
        protected override AnimationPositionCollection[] SetHandPositions
        {
            get
            {
                ...
                Hands[0].AddFramePoint2X(11, 27, 2);
                Hands[0].AddFramePoint2X(12, 38, 15);
                Hands[0].AddFramePoint2X(13, 40, 37);

                Hands[0].AddFramePoint2X(14, 21, 2);
                Hands[0].AddFramePoint2X(15, 33, 12);
                Hands[0].AddFramePoint2X(16, 37, 22);
                Hands[0].AddFramePoint2X(17, 32, 30);

                Hands[0].AddFramePoint2X(22, 38, 43);

                //Right Hand
                Hands[1] = new AnimationPositionCollection(30, 32, true);
                Hands[1].AddFramePoint2X(11, 30, 2);
                Hands[1].AddFramePoint2X(12, 41, 15);
                Hands[1].AddFramePoint2X(13, 42, 37);

                Hands[1].AddFramePoint2X(14, 23, 2);
                Hands[1].AddFramePoint2X(15, 36, 12);
                Hands[1].AddFramePoint2X(16, 39, 22);
                Hands[1].AddFramePoint2X(17, 35, 30);
                return Hands;
            }
        }
        protected override AnimationPositionCollection SetMountShoulderPosition
        {
            get
            {
                AnimationPositionCollection a = new AnimationPositionCollection(16, 13, true);
