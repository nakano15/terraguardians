...
namespace terraguardians.Companions.Quentin
{
    public class QuentinCompanion : Companion
    {
        ...
        public override void CompanionDrawHeadSetup(PlayerDrawSet drawSet, ref TgDrawInfoHolder Holder, ref List<DrawData> DrawDatas)
        {
            DrawHead(drawSet, ref Holder);
        }
        ...
        void DrawHead(PlayerDrawSet drawSet, ref TgDrawInfoHolder Holder)
        {
