...
namespace terraguardians.NPCs.CompanionNPCSpawner
{
    public class BrutusSpawner : CompanionNpcSpawner
    {
        ...
        {
            if (TargetIsPlayer(spawnInfo.Player) || !CanSpawnCompanionNpc() || Main.fastForwardTime || (Main.invasionType > 0 && Main.invasionSize > 0) || !spawnInfo.PlayerInTown || spawnInfo.Water  || Main.eclipse || !Main.dayTime || Main.time < 3 * 3600)
                return 0;
