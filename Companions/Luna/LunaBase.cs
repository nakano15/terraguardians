...
namespace terraguardians.Companions
{
    public class LunaBase : TerraGuardianBase
    {
        ...
        protected override AnimationPositionCollection SetHeadVanityPosition
        {
            get
            {
                AnimationPositionCollection anim = new AnimationPositionCollection(22, 12);
        ...
        {
            if (companion.sitting.isSitting && companion.BodyFrameID != 25 && companion.Owner != null && companion.Owner is Player)
            {
